...
import com.mills.advent.support.toGrid
import com.mills.advent.support.validCoord

const val MAX_VALUE = 1000000

class Day15 : AdventOfCode {
    private fun getInputText(): String = Day15::class.java.getResource("day15.txt")?.readText()!!
